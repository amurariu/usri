...
\begin{flushleft}
{\Large
\textbf{Not every gene is special: controlling the false discovery rate when analysing high-throughput sequencing data} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
         ...
         Tianyi 16S rRNA & \textbf{2.61} (0.85) & \textbf{0.64} (0.14) & \textbf{1.66} (0.37) & \textbf{0.72} (0.11) \\
