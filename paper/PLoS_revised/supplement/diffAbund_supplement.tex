...
\paragraph*{Fig. \ref{fig:supFigFDR_TPR_all}}
False-discovery and true-positive rates for all datasets tested.

\paragraph*{Fig. \ref{fig:supFigPPV}}
...
\begin{table}[H]
    ...
    \begin{tabular}{ccrr}
         ...
         \multirow{6}{*}{TCGA} & 0 & \textbf{0.24} (0.056) & \textbf{0.25} (0.055)\\
          ...
          \midrule
         \multirow{6}{*}{Tiyani 16S rRNA} & 0 & \textbf{0.75} (0.148) & \textbf{0.78} (0.136)\\
          & 0.1 & \textbf{0.85} (0.154) & \textbf{0.85} (0.088)\\
          & 0.2 & \textbf{1.08} (0.127) & \textbf{1.01} (0.144)\\
          & 0.3 & \textbf{1.38} (0.205) & \textbf{1.18} (0.171)\\
          & 0.4 & \textbf{1.66} (0.305) & \textbf{1.41} (0.179)\\
          & 0.5 & \textbf{2.03} (0.440) & \textbf{1.58} (0.221)\\
          \midrule
