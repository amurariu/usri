...
# run ALDEx2 at gamma = 0.4, then save
oral.data_4.aldex2 <- ald2.fun(data=as.matrix(oral.filt), conditions=conditions_o$group, nloop=100, gamma=0.4)
save(oral.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/oral.data.aldex2_4.Rda")
