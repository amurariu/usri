...
prad.data.limma.asym0.90 <- lim.fun(prad.data, prad.conds, 100, mean = 0, prop_null = 0.90)
save(prad.data.limma.asym0.90, file="/Volumes/data2/andreea/ext_analysis/prad.data.limma.asym0.prop90.Rda") 
