...
# run aldex2 with gamma = 1e-3, then save
pseudo.data_0.aldex2 <- ald2.fun(data = sc.pseudo, conditions = conds.stim$stim, nloop=100, gamma=1e-3, prop_null = 0.95, mean = 0, nsample = 128, std = 2)
save(pseudo.data_0.aldex2, file="~/Documents/GitHub/ext_analysis/pseudo_sc.data.aldex2_0.Rda")
