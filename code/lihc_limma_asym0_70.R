...
lihc.data.limma.asym0.70 <- lim.fun(lihc.data, lihc.conds, 100, mean = 0, prop_null = 0.70)
save(lihc.data.limma.asym0.70, file="/Volumes/data2/andreea/ext_analysis/lihc.data.limma.asym0.prop70.Rda") 