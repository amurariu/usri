...
fre.data.limma <- lim.fun(data = as.matrix(fre.filt), conditions = conditions_f$comparison, nloop = 100, mean = 0, prop_null = 0.95)
save(fre.data.limma, file="/Volumes/data2/andreea/ext_analysis/fre.data.limma.Rda") 