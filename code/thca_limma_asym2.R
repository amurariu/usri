...
thca.data.limma.asym2 <- lim.fun(thca.data, thca.conds, 100, mean = 2)
save(thca.data.limma.asym2, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym2.Rda") 