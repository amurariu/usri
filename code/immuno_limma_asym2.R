...
immuno.data.limma.asym2 <- lim.fun(immuno.data, immuno.conds, 100, mean = 2)
save(immuno.data.limma.asym2, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym2.Rda") 
