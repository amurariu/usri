...
cdiff.data_4.aldex2 <- ald2.fun(data=as.matrix(cdiff.filt), conditions=cdiff.conds$comparison, nloop=100, gamma=0.4)
save(cdiff.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/cdiff.data.aldex2_4.Rda")