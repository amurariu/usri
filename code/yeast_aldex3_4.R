...
#save file - gamma=0.4
yeast.data_4.aldex3 <- ald3.fun(data=yeast.data, conds=yeast.conds$conditions_y, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(yeast.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex3_4.Rda")