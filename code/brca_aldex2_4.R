...
#save file - gamma = 0.4
brca.data_4.aldex2 <- ald2.fun(data=brca.data, conditions=brca.conds$conditions_b, nloop=100, gamma=0.4)
save(brca.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex2_4.Rda")