...
brca.data.limma.asym1.70 <- lim.fun(brca.data, brca.conds, 100, mean = 1, prop_null = 0.70)
save(brca.data.limma.asym1.70, file="/Volumes/data2/andreea/ext_analysis/brca.data.limma.asym1.prop70.Rda") 