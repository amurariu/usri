...
# run ALDEx2 at gamma = 1e-3, then save
oral.data_0.aldex2 <- ald2.fun(data=as.matrix(oral.filt), conditions=conditions_o$group, nloop=100, gamma=1e-3)
save(oral.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/oral.data.aldex2_0.Rda")
