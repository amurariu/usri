...
prad.data.limma.asym2 <- lim.fun(prad.data, prad.conds, 100, mean = 2)
save(prad.data.limma.asym2 file="/Volumes/data2/andreea/ext_analysis/prad.data.limma.asym2.Rda") 
