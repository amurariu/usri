...
#save file - gamma = 0.5
thca.data_5.aldex2 <- ald2.fun(data=thca.data, conditions=thca.conds$conditions_t, nloop=100, gamma = 0.5)
save(thca.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/thca.data.aldex2_5.Rda")
