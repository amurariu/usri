...
thca.data.limma.asym1.70 <- lim.fun(thca.data, thca.conds, 100, mean = 1, prop_null = 0.70)
save(thca.data.limma.asym1.70, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym1.prop70.Rda") 