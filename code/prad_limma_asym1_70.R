...
prad.data.limma.asym1.70 <- lim.fun(prad.data, prad.conds, 100, mean = 1, prop_null = 0.70)
save(prad.data.limma.asym1.70, file="/Volumes/data2/andreea/ext_analysis/prad.data.limma.asym1.prop70.Rda") 
