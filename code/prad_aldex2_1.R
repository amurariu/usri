...
#save file - gamma = 0.1
prad.data_1.aldex2 <- ald2.fun(data=prad.data, conditions=prad.conds$conditions_pr, nloop=100, gamma=0.1)
save(prad.data_1.aldex2, file="/Volumes/data2/andreea/ext_analysis/prad.data.aldex2_1.Rda")