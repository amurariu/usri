...
#left-side panel
  ...
  points(coeff,ald3_0.conf$TPFPR[,3], col="steelblue1", type='b', lty=3)
  points(coeff,ald3_1.conf$TPFPR[,3], col="steelblue1", type='b', lty=3, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,3], col="steelblue1", type='b', lty=3, pch='2', cex=0.6)
  points(coeff,ald3_5.conf$TPFPR[,3], col="steelblue1", type='b', lty=3, pch='5', cex=0.6)
...
points(coeff,ald3_0.conf$TPFPR[,7], col="steelblue1", type='b', lty=3)
points(coeff,ald3_1.conf$TPFPR[,7], col="steelblue1", type='b', lty=3, pch='1', cex=0.6)
points(coeff,ald3_2.conf$TPFPR[,7], col="steelblue1", type='b', lty=3, pch='2', cex=0.6)
points(coeff,ald3_5.conf$TPFPR[,7], col="steelblue1", type='b', lty=3, pch='5', cex=0.6)
