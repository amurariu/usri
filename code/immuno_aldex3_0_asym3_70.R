...
immuno.data_0.aldex3.asym3.70 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=1e-3, prop_null = 0.70, mean = 3)
save(immuno.data_0.aldex3.asym3.70, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_0.asym3.prop70.Rda")