...
#save file - gamma = 0.3
thca.data_3.aldex2 <- ald2.fun(data=thca.data, conditions=thca.conds$conditions_t, nloop=100, gamma = 0.3)
save(thca.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/thca.data.aldex2_3.Rda")
