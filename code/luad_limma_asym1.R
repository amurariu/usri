...
luad.data.limma.asym1 <- lim.fun(luad.data, luad.conds, 100, mean = 1)
save(luad.data.limma.asym1, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym1.Rda") 