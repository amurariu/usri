...
#save file - gamma=0.5
yeast.data_5.aldex2 <- ald2.fun(data=yeast.data, conditions=yeast.conds$conditions_y, nloop=100, gamma=0.5)
save(yeast.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex2_5.Rda")