...
immuno.data_4.aldex3 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(immuno.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_4.Rda")
