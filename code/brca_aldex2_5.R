...
#save file - gamma = 0.5
brca.data_5.aldex2 <- ald2.fun(data=brca.data, conditions=brca.conds$conditions_b, nloop=100, gamma = 0.5)
save(brca.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex2_5.Rda")
