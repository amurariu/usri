...
lihc.data_0.aldex2 <- ald2.fun(data=lihc.data, conditions=lihc.conds$conditions_li, nloop=100, gamma=1e-3)
save(lihc.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/lihc.data.aldex2_0.Rda")