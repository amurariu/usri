# running aldex3 (0 gamma) on vaginal metatranscriptome dataset (healthy vs. BV)
...
mts.data_0.aldex3 <- ald3.fun(data = mts.counts, nloop = 100,
                              conds = mts.meta$groups.2, gamma = 1e-3, prop_null = 0.95, mean = 0)

save(mts.data_0.aldex3, file = "/Volumes/data2/andreea/ext_analysis/mts.data.aldex3_0.Rda")
