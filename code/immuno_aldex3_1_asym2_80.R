...
immuno.data_1.aldex3.asym2.80 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=0.1, prop_null = 0.80, mean = 2)
save(immuno.data_1.aldex3.asym2.80, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_1.asym2.prop80.Rda")