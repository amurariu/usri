...
immuno.data_1.aldex3.asym3.90 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=0.1, prop_null = 0.90, mean = 3)
save(immuno.data_1.aldex3.asym3.90, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_1.asym3.prop90.Rda")