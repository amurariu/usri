...
immuno.data.limma.asym3 <- lim.fun(immuno.data, immuno.conds, 100, mean = 3)
save(immuno.data.limma.asym3, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym3.Rda") 
