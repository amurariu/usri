...
thca.data_2.aldex3 <- ald3.fun(data=thca.data, conds=thca.conds$conditions_t, nloop=100, gamma=0.2)
save(thca.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/thca.data.aldex3_2.Rda")