...
hiv.data_1.aldex2 <- ald2.fun(data=as.matrix(hiv), conditions=hiv.conds$conditions_h, nloop=100, gamma=0.1)
save(hiv.data_1.aldex2, file="../ext_analysis/hiv.data.aldex2_1.Rda")