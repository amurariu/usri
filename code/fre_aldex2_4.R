...
fre.data_4.aldex2 <- ald2.fun(data=as.matrix(fre.filt), conditions=fre.conds$comparison, nloop=100, gamma=0.4)
save(fre.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/fre.data.aldex2_4.Rda")