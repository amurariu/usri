...
# run aldex3 with gamma = 0.5, then save
pseudo.data_5.aldex3 <- ald3.fun(data = sc.pseudo, conds = conds.stim$stim, nloop = 100, gamma=0.5, prop_null = 0.95, mean = 0, std = 2)
save(pseudo.data_5.aldex3, file="~/Documents/GitHub/ext_analysis/pseudo_sc.data.aldex3_5.Rda")
