# running aldex3 (0.5 gamma) on cpn60 dataset (ST3, abx vs. no abx exposure)
...
cpn60.data.aldex3.5 <- ald3.fun(data = cpn60.counts, nloop = 100,
                                conds = cpn60.meta$abx, gamma = 0.5)

save(cpn60.data.aldex3.5, file = "../ext_analysis/mts.data.aldex3_5.Rda")
