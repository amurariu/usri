...
kirc.data.limma.asym2 <- lim.fun(kirc.data, kirc.conds, 100, mean = 2)
save(kirc.data.limma.asym2, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym2.Rda") 
