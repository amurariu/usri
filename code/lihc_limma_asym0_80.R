...
lihc.data.limma.asym0.80 <- lim.fun(lihc.data, lihc.conds, 100, mean = 0, prop_null = 0.80)
save(lihc.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/lihc.data.limma.asym0.prop80.Rda") 