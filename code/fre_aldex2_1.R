...
fre.data_1.aldex2 <- ald2.fun(data=as.matrix(fre.filt), conditions=fre.conds$comparison, nloop=100, gamma=0.1)
save(fre.data_1.aldex2, file="/Volumes/data2/andreea/ext_analysis/fre.data.aldex2_1.Rda")