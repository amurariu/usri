...
brca.data.limma.asym0.80 <- lim.fun(brca.data, brca.conds, 100, mean = 0, prop_null = 0.80)
save(brca.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/brca.data.limma.asym1.prop80.Rda") 