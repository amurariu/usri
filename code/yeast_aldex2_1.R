...
#save file - gamma=0.1
yeast.data_1.aldex2 <- ald2.fun(data=yeast.data, conditions=yeast.conds$conditions_y, nloop=100, gamma=0.1)
save(yeast.data_1.aldex2, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex2_1.Rda")