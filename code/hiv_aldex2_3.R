...
hiv.data_3.aldex2 <- ald2.fun(data=as.matrix(hiv.filt), conditions=hiv.conds$comparison, nloop=100, gamma=0.3)
save(hiv.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/hiv.data.aldex2_3.Rda")