...
immuno.data_5.aldex3 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=0.5)
save(immuno.data_5.aldex3, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_5.Rda")
