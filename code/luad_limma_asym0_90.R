...
luad.data.limma.asym0.90 <- lim.fun(luad.data, luad.conds, 100, mean = 0, prop_null = 0.90)
save(luad.data.limma.asym0.90, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym0.prop90.Rda") 