...
immuno.data_0.aldex2 <- ald2.fun(data=immuno.data, conditions=immuno.conds$conditions_p, nloop=100, gamma=1e-3)
save(immuno.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex2_0.Rda")