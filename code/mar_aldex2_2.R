...
mar.data_2.aldex2 <- ald2.fun(data=as.matrix(mar), conditions=mar.conds$conditions_m, nloop=100, gamma=0.2)
save(mar.data_2.aldex2, file="../ext_analysis/mar.data.aldex2_2.Rda")