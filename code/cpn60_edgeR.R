# running edgeR on cpn60 dataset (ST3, abx vs. no abx exposure)
...
# load edgeR function for generating randomised/thinned data
...
cpn60.data.edgeR <- edg.fun(data = cpn60.counts, conditions = cpn60.meta$abx, nloop = 100)
