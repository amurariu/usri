...
mar.data_2.aldex3 <- ald3.fun(data=as.matrix(mar.filt), conds=conditions_m$comparison, nloop=100, gamma=0.2, prop_null = 0.95, mean = 0)
save(mar.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/mar.data.aldex3_2.Rda")
