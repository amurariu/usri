...
#save file - gamma = 0.3
kirc.data_3.aldex2 <- ald2.fun(data=kirc.data, conditions=kirc.conds$conditions_k, nloop=100, gamma=0.3)
save(kirc.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/kirc.data.aldex2_3.Rda")