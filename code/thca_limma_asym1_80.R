...
thca.data.limma.asym1.80 <- lim.fun(thca.data, thca.conds, 100, mean = 1, prop_null = 0.80)
save(thca.data.limma.asym1.80, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym1.prop80.Rda") 