# running aldex2 (0.4 gamma) on vaginal metatranscriptome dataset (healthy vs. BV)
...
mts.data_4.aldex2 <- ald2.fun(data = mts.counts, nloop = 100,
                              conditions = mts.meta$groups.2, gamma = 0.4)

save(mts.data_4.aldex2, file = "/Volumes/data2/andreea/ext_analysis/mts.data.aldex2_4.Rda")
