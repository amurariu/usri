...
immuno.data.limma.asym1.80 <- lim.fun(immuno.data, immuno.conds, 100, mean = 1, prop_null = 0.80)
save(immuno.data.limma.asym1.80, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym1.prop80.Rda") 
