...
luad.data_5.aldex3 <- ald3.fun(data=luad.data, conds=luad.conds$conditions_lu, nloop=100, gamma=0.5)
save(luad.data_5.aldex3, file="/Volumes/data2/andreea/ext_analysis/luad.data.aldex3_5.Rda")