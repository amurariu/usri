...
kirc.data.limma.asym1.80 <- lim.fun(kirc.data, kirc.conds, 100, mean = 1, prop_null = 0.80)
save(kirc.data.limma.asym1.80, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym1.prop80.Rda") 
