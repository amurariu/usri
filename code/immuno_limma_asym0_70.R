...
immuno.data.limma.asym0.70 <- lim.fun(immuno.data, immuno.conds, 100, mean = 0, prop_null = 0.70)
save(immuno.data.limma.asym0.70, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym0.prop70.Rda") 
