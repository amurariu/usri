...
thca.data.limma.asym1.90 <- lim.fun(thca.data, thca.conds, 100, mean = 1, prop_null = 0.90)
save(thca.data.limma.asym1.90, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym1.prop90.Rda") 