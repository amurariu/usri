...
immuno.data_0.aldex2 <- ald2.fun(data=immuno.data, conditions=conditions_p, nloop=2, gamma=1e-3)
save(immuno.data_0.aldex2, file="../ext_analysis/immuno.data.aldex2_0.out.Rda")

#save file - gamma=0.2
immuno.data_2.aldex2 <- ald2.fun(data=immuno.data, conditions=conditions_p, nloop=2, gamma = 0.2)
save(immuno.data_2.aldex2, file="../ext_analysis/immuno.data.aldex2_2.out.Rda")

#save file - gamma=0.5
immuno.data_5.aldex2 <- ald2.fun(data=immuno.data, conditions=conditions_p, nloop=2, gamma = 0.5)
