...
#save file - gamma = 0.4
prad.data_4.aldex2 <- ald2.fun(data=prad.data, conditions=prad.conds$conditions_pr, nloop=100, gamma=0.4)
save(prad.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/prad.data.aldex2_4.Rda")
