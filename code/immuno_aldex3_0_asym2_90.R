...
immuno.data_0.aldex3.asym2.90 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=1e-3, prop_null = 0.90, mean = 2)
save(immuno.data_0.aldex3.asym2.90, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_0.asym2.prop90.Rda")