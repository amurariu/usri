lim.fun <- function(data, conditions, nloop=10, mean, prop_null){
  ...
  for (i in 1:nloop){
    ...
    message("Running Limma on original data with randomised groups...")
    ...
    message("Running Limma on thinned data with randomised groups...")
  ...
  message("Running Limma on original data with non-randomised groups...")
