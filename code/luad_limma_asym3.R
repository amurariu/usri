...
luad.data.limma.asym3 <- lim.fun(luad.data, luad.conds, 100, mean = 3)
save(luad.data.limma.asym3, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym3.Rda") 