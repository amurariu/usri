...
sccyto.data_0.aldex2 <- ald2.fun(data=as.matrix(sccyto.filt), conditions=sccyto.conds$comparison, nloop=100, gamma=1e-3)
save(sccyto.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/sccyto.data.aldex2_0.Rda")
