...
brca.data.limma.asym2 <- lim.fun(brca.data, brca.conds, 100, mean = 2)
save(brca.data.limma.asym2, file="/Volumes/data2/andreea/ext_analysis/brca.data.limma.asym2.Rda") 