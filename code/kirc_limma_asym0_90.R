...
kirc.data.limma.asym0.90 <- lim.fun(kirc.data, kirc.conds, 100, mean = 0, prop_null = 0.90)
save(kirc.data.limma.asym0.90, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym0.prop90.Rda") 
