...
# run using gamma = 0.3 and save to .Rda
sccyto.data_3.aldex3 <- ald3.fun(data=as.matrix(sccyto.filt), conds=conditions_s$comparison, nloop=100, gamma=0.3, prop_null = 0.95, mean = 0)
save(sccyto.data_3.aldex3, file="/Volumes/data2/andreea/ext_analysis/sccyto.data.aldex3_3.Rda")
