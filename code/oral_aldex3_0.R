...
# run ALDEx3 at gamma = 1e-3, then save
oral.data_0.aldex3 <- ald3.fun(data=as.matrix(oral.filt), conds=conditions_o$group, nloop=100, gamma=1e-3, prop_null = 0.95, mean = 0)
