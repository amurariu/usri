...
thca.data.limma.asym0.80 <- lim.fun(thca.data, thca.conds, 100, mean = 0, prop_null = 0.80)
save(thca.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym0.prop80.Rda") 