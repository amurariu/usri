...
fre.data_4.aldex3 <- ald3.fun(data=as.matrix(fre.filt), conds=conditions_f$comparison, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(fre.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/fre.data.aldex3_4.Rda")
