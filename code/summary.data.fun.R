...
#summary for gamma = 1e-3, ALDEx2
  ...
  absmax0 <- matrix(data = NA, ncol = 1, nrow = 100)
  colnames(minmax2_0)<-c('max', 'min', 'abs')
  for(i in 1:100){
    gt0 <- aldex2_0$t.data[[i]]$diff.btw > 0
    lt0 <- aldex2_0$t.data[[i]]$diff.btw < 0
    sig0 <- aldex2_0$t.data[[i]]$we.eBH < 0.05
    minmax2_0[i,2] <- min(aldex2_0$t.data[[i]]$diff.btw[gt0 & sig0])
    minmax2_0[i,1] <- max(aldex2_0$t.data[[i]]$diff.btw[lt0 & sig0])
    absmin0[i] <- abs(min(aldex2_0$t.data[[i]]$diff.btw[gt0 & sig0]))
    absmax0[i] <- abs(max(aldex2_0$t.data[[i]]$diff.btw[lt0 & sig0]))
  } 
...
absmin1 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax1 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin2 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax2 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin5 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax5 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin3_0 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax3_0 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin3_1 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax3_1 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin3_2 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax3_2 <- matrix(data = NA, ncol = 1, nrow = 100)
...
absmin3_5 <- matrix(data = NA, ncol = 1, nrow = 100)
absmax3_5 <- matrix(data = NA, ncol = 1, nrow = 100)
