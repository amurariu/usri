...
for(i in 1:100){
  ...
  absmin0 <- abs(min(aldex2_0$t.data[[i]]$diff.btw[gt0 & sig]))
  absmax0 <- abs(max(aldex2_0$t.data[[i]]$diff.btw[lt0 & sig]))
  } 
minmax2_0[,3] <- rbind(absmin0, absmax0)
...
for(i in 1:100){
  ...
  absmin1 <- abs(min(aldex2_1$t.data[[i]]$diff.btw[gt1 & sig1]))
  absmax1 <- abs(max(aldex2_1$t.data[[i]]$diff.btw[lt1 & sig1]))
  } 
...
for(i in 1:100){
  ...
  absmin2 <- abs(min(aldex2_2$t.data[[i]]$diff.btw[gt2 & sig2]))
  absmax2 <- abs(max(aldex2_2$t.data[[i]]$diff.btw[lt2 & sig2]))
}
...
for(i in 1:100){
  ...
  absmin5 <- abs(min(aldex2_5$t.data[[i]]$diff.btw[gt5 & sig5]))
  absmax5 <- abs(max(aldex2_5$t.data[[i]]$diff.btw[lt5 & sig5]))
}
...
for(i in 1:100){
  ...
  absmin3_0 <- abs(min(aldex3_0$t.data[[i]]$estimate[gt3_0 & sig3_0]))
  absmax3_0 <- abs(max(aldex3_0$t.data[[i]]$estimate[lt3_0 & sig3_0]))
}
...
for(i in 1:100){
  ...
  absmin3_1 <- abs(min(aldex3_1$t.data[[i]]$estimate[gt3_1 & sig3_1]))
  absmax3_1 <- abs(max(aldex3_1$t.data[[i]]$estimate[lt3_1 & sig3_1]))
}
...
for(i in 1:100){
  ...
  absmin3_2 <- abs(min(aldex3_2$t.data[[i]]$estimate[gt3_2 & sig3_2]))
  absmax3_2 <- abs(max(aldex3_2$t.data[[i]]$estimate[lt3_2 & sig3_2]))
}
...
for(i in 1:100){
  ...
  absmin3_5 <- abs(min(aldex3_5$t.data[[i]]$estimate[gt3_5 & sig3_5]))
  absmax3_5 <- abs(max(aldex3_5$t.data[[i]]$estimate[lt3_5 & sig3_5]))
}
