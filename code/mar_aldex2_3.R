...
mar.data_3.aldex2 <- ald2.fun(data=as.matrix(mar.filt), conditions=mar.conds$comparison, nloop=100, gamma=0.3)
save(mar.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/mar.data.aldex2_3.Rda")