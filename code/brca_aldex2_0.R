...
brca.data_0.aldex2 <- ald2.fun(data=brca.data, conditions=brca.conds$conditions_b, nloop=100, gamma=1e-3)
save(brca.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex2_0.Rda")