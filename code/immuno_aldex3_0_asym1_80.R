...
immuno.data_0.aldex3.asym1.80 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=1e-3, prop_null = 0.80, mean = 1)
save(immuno.data_0.aldex3.asym1.80, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_0.asym1.prop80.Rda")