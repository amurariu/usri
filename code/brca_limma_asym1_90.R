...
brca.data.limma.asym1.90 <- lim.fun(brca.data, brca.conds, 100, mean = 1, prop_null = 0.90)
save(brca.data.limma.asym1.90, file="/Volumes/data2/andreea/ext_analysis/brca.data.limma.asym1.prop90.Rda") 