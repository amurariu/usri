...
#save file - gamma = 0.5
lihc.data_5.aldex2 <- ald2.fun(data=lihc.data, conditions=lihc.conds$conditions_li, nloop=100, gamma = 0.5)
save(lihc.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/lihc.data.aldex2_5.Rda")