...
thca.data.limma.asym0.90 <- lim.fun(thca.data, thca.conds, 100, mean = 0, prop_null = 0.90)
save(thca.data.limma.asym0.90, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym0.prop90.Rda") 