...
kirc.data_0.aldex2 <- ald2.fun(data=kirc.data, conditions=kirc.conds$conditions_k, nloop=100, gamma=1e-3)
save(kirc.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/kirc.data.aldex2_0.Rda")