...
#save file - gamma = 0.4
kirc.data_4.aldex3 <- ald3.fun(data=kirc.data, conds=kirc.conds$conditions_k, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(kirc.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/kirc.data.aldex3_4.Rda")