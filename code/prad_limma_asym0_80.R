...
prad.data.limma.asym0.80 <- lim.fun(prad.data, prad.conds, 100, mean = 0, prop_null = 0.80)
save(prad.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/prad.data.limma.asym0.prop80.Rda") 
