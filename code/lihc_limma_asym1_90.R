...
lihc.data.limma.asym1.90 <- lim.fun(lihc.data, lihc.conds, 100, mean = 1, prop_null = 0.90)
save(lihc.data.limma.asym1.90, file="/Volumes/data2/andreea/ext_analysis/lihc.data.limma.asym1.prop90.Rda") 