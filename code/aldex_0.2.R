...
#Save files here
#PD1 save file
save(immuno.data.out.u, file="./analysis/immuno.data.u.aldex2.Rda")
save(immuno.data.out.r, file="./analysis/immuno.data.r.aldex2.Rda")
save(immuno.data.out.p, file="./analysis/immuno.data.p.aldex2.Rda")

#BRCA save file
save(brca.data.out.u, file="./analysis/brca.data.u.aldex2.Rda")
save(brca.data.out.r, file="./analysis/brca.data.r.aldex2.Rda")
save(brca.data.out.p, file="./analysis/brca.data.p.aldex2.Rda")
