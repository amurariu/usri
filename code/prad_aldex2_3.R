...
#save file - gamma = 0.3
prad.data_3.aldex2 <- ald2.fun(data=prad.data, conditions=prad.conds$conditions_pr, nloop=100, gamma=0.3)
save(prad.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/prad.data.aldex2_3.Rda")
