...
brca.data_4.aldex3 <- ald3.fun(data=brca.data, conds=brca.conds$conditions_b, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(brca.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex3_4.Rda")
