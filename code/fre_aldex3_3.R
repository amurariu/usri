...
fre.data_3.aldex3 <- ald3.fun(data=as.matrix(fre.filt), conds=conditions_f$comparison, nloop=100, gamma=0.3, prop_null = 0.95, mean = 0)
save(fre.data_3.aldex3, file="/Volumes/data2/andreea/ext_analysis/fre.data.aldex3_3.Rda")
