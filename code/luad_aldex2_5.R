...
#save file - gamma = 0.5
luad.data_5.aldex2 <- ald2.fun(data=luad.data, conditions=luad.conds$conditions_lu, nloop=100, gamma = 0.5)
save(luad.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/luad.data.aldex2_5.Rda")