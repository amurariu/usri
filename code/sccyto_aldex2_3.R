...
sccyto.data_3.aldex2 <- ald2.fun(data=as.matrix(sccyto.filt), conditions=sccyto.conds$comparison, nloop=100, gamma=0.3)
save(sccyto.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/sccyto.data.aldex2_3.Rda")
