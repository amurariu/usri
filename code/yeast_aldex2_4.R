...
#save file - gamma=0.4
yeast.data_4.aldex2 <- ald2.fun(data=yeast.data, conditions=yeast.conds$conditions_y, nloop=100, gamma=0.4)
save(yeast.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex2_4.Rda")