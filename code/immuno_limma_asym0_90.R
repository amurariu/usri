...
immuno.data.limma.asym0.90 <- lim.fun(immuno.data, immuno.conds, 100, mean = 0, prop_null = 0.90)
save(immuno.data.limma.asym0.90, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym0.prop90.Rda") 
