...
prad.data_5.aldex3 <- ald3.fun(data=prad.data, conds=prad.conds$conditions_pr, nloop=100, gamma=0.5)
save(prad.data_5.aldex3, file="/Volumes/data2/andreea/ext_analysis/prad.data.aldex3_5.Rda")