...
kirc.data.limma.asym0.70 <- lim.fun(kirc.data, kirc.conds, 100, mean = 0, prop_null = 0.70)
save(kirc.data.limma.asym0.70, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym0.prop70.Rda") 
