...
brca.data_5.aldex3 <- ald3.fun(data=brca.data, conds=brca.conds$conditions_b, nloop=100, gamma=0.5)
save(brca.data_5.aldex3, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex3_5.Rda")