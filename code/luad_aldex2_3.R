...
#save file - gamma = 0.3
luad.data_3.aldex2 <- ald2.fun(data=luad.data, conditions=luad.conds$conditions_lu, nloop=100, gamma=0.3)
save(luad.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/luad.data.aldex2_3.Rda")