...
cdiff.data_0.aldex2 <- ald2.fun(data=as.matrix(cdiff), conditions=cdiff.conds$conditions_c, nloop=100, gamma=1e-3)
save(cdiff.data_0.aldex2, file="../ext_analysis/cdiff.data.aldex2_0.Rda")