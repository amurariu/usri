...
thca.data_0.aldex2 <- ald2.fun(data=thca.data, conditions=thca.conds$conditions_t, nloop=100, gamma=1e-3)
save(thca.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/thca.data.aldex2_0.Rda")
