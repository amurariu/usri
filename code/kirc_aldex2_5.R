...
#save file - gamma=0.5
kirc.data_5.aldex2 <- ald2.fun(data=kirc.data, conditions=kirc.conds$conditions_k, nloop=100, gamma = 0.5)
save(kirc.data_5.aldex2, file="/Volumes/data2/andreea/ext_analysis/kirc.data.aldex2_5.Rda")
