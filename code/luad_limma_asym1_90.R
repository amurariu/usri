...
luad.data.limma.asym1.90 <- lim.fun(luad.data, luad.conds, 100, mean = 1, prop_null = 0.90)
save(luad.data.limma.asym1.90, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym1.prop90.Rda") 