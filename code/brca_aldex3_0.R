...
brca.data_0.aldex3 <- ald3.fun(data=brca.data, conds=brca.conds$conditions_b, nloop=100, gamma=1e-3)
save(brca.data_0.aldex3, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex3_0.Rda")
