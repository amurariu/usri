...
graph.fun <- function( DESeq_var, edgeR_var, limma_var, aldex_0_var, aldex_2_var, aldex_5_var, limma_a1, limma_a2,limma_a3, lim.90, lim.80, lim.70){
  ...
  ald3_0.conf <- get_confusion(aldex_3_0_var, "ALDEx2")
  ald3_1.conf <- get_confusion(aldex_3_1_var, "ALDEx2")
  ald3_2.conf <- get_confusion(aldex_3_2_var, "ALDEx2")
