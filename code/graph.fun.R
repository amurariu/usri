...
graph.fun <- function(aldex_0_var, aldex_1_var, aldex_2_var, aldex_5_var, aldex3_0_var, aldex3_1_var, aldex3_2_var, aldex3_5_var, limma_var){
  
  #perform get_confusion function first
  # des.conf <- get_confusion(DESeq_var, "DESeq")
  # edge.conf <- get_confusion(edgeR_var, "edgeR")
  limma.conf <- get_confusion(limma_var, "limma", FDR = 0.1)
  limma.conf5 <- get_confusion(limma_var, "limma", FDR = 0.05)
