...
graph.fun <- function( DESeq_var, edgeR_var, limma_var, aldex_0_var, aldex_1_var, aldex_2_var, aldex_5_var, aldex3_0_var, aldex3_1_var, aldex3_2_var ){
  ...
  ald3_0.conf <- get_confusion(aldex3_0_var, "ALDEx2")
  ald3_1.conf <- get_confusion(aldex3_1_var, "ALDEx2")
  ald3_2.conf <- get_confusion(aldex3_2_var, "ALDEx2")
  ...
  points(coeff, ald3_0.conf$TPFPR[,1], col="purple", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,1], col="purple", type='b', pch='1', lty=1, cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,1], col="purple", type='b', pch='2', lty=1, cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,1], col="purple", type='b', pch='5', lty=1, cex=0.6)
  points(coeff,ald3_0.conf$TPFPR[,2], col="purple", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,2], col="purple", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,2], col="purple", type='b', lty=2, pch='2', cex=0.6)
 # points(coeff,ald3_5.conf$TPFPR[,2], col="purple", type='b', lty=2, pch='5', cex=0.6)
  
  points(coeff,ald3_0.conf$TPFPR[,3], col="violet", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,3], col="violet", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,3], col="violet", type='b', lty=2, pch='2', cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,3], col="violet", type='b', lty=2, pch='5', cex=0.6)
  points(coeff,ald3_0.conf$TPFPR[,4], col="violet", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,4], col="violet", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,4], col="violet", type='b', lty=2, pch='2', cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,4], col="violet", type='b', lty=2, pch='5', cex=0.6)
  ...
  points(coeff, ald3_0.conf$TPFPR[,5], col="purple", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,5], col="purple", type='b', pch='1', lty=1, cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,5], col="purple", type='b', pch='2', lty=1, cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,5], col="purple", type='b', pch='5', lty=1, cex=0.6)
  points(coeff,ald3_0.conf$TPFPR[,6], col="purple", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,6], col="purple", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,6], col="purple", type='b', lty=2, pch='2', cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,6], col="purple", type='b', lty=2, pch='5', cex=0.6)
  
  points(coeff,ald3_0.conf$TPFPR[,7], col="violet", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,7], col="violet", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,7], col="violet", type='b', lty=2, pch='2', cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,7], col="violet", type='b', lty=2, pch='5', cex=0.6)
  points(coeff,ald3_0.conf$TPFPR[,8], col="violet", type='b', lty=2)
  points(coeff,ald3_1.conf$TPFPR[,8], col="violet", type='b', lty=2, pch='1', cex=0.6)
  points(coeff,ald3_2.conf$TPFPR[,8], col="violet", type='b', lty=2, pch='2', cex=0.6)
  #points(coeff,ald3_5.conf$TPFPR[,8], col="violet", type='b', lty=2, pch='5', cex=0.6)
