...
graph.fun <- function(DESeq_var, edgeR_var, limma_var, aldex_0_var, aldex_1_var, aldex_2_var, aldex_5_var, aldex3_0_var, aldex3_1_var, aldex3_2_var, aldex3_5_var){
  ...
  lim.conf <- get_confusion(limma_var, "limma")
