...
# run ALDEx3 at gamma = 0.2, then save
oral.data_2.aldex3 <- ald3.fun(data=as.matrix(oral.filt), conds=conditions_o$group, nloop=100, gamma=0.2, prop_null = 0.95, mean = 0)
save(oral.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/oral.data.aldex3_2.Rda")
