...
brca.data_2.aldex3 <- ald3.fun(data=brca.data, conds=brca.conds$conditions_b, nloop=100, gamma=0.2)
save(brca.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex3_2.Rda")