...
mar.data_0.aldex2 <- ald2.fun(data=as.matrix(mar.filt), conditions=mar.conds$comparison, nloop=100, gamma=1e-3)
save(mar.data_0.aldex2, file="/Volumes/data2/andreea/ext_analysis/mar.data.aldex2_0.Rda")