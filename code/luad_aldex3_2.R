...
luad.data_2.aldex3 <- ald3.fun(data=luad.data, conds=luad.conds$conditions_lu, nloop=100, gamma=0.2)
save(luad.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/luad.data.aldex3_2.Rda")