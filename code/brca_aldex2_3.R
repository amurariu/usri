...
#save file - gamma = 0.3
brca.data_3.aldex2 <- ald2.fun(data=brca.data, conditions=brca.conds$conditions_b, nloop=100, gamma=0.3)
save(brca.data_3.aldex2, file="/Volumes/data2/andreea/ext_analysis/brca.data.aldex2_3.Rda")