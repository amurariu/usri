...
# run aldex2 with gamma = 0.5, then save
pseudo.data_5.aldex2 <- ald2.fun(data = sc.pseudo, conditions = conds.stim$stim, nloop=100, gamma=0.5)
save(pseudo.data_5.aldex2, file="~/Documents/GitHub/ext_analysis/pseudo_sc.data.aldex2_5.Rda")
