...
#save file - gamma = 0.4
lihc.data_4.aldex2 <- ald2.fun(data=lihc.data, conditions=lihc.conds$conditions_li, nloop=100, gamma=0.4)
save(lihc.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/lihc.data.aldex2_4.Rda")