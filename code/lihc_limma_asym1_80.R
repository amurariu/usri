...
lihc.data.limma.asym1.80 <- lim.fun(lihc.data, lihc.conds, 100, mean = 1, prop_null = 0.80)
save(lihc.data.limma.asym1.80, file="/Volumes/data2/andreea/ext_analysis/lihc.data.limma.asym1.prop80.Rda") 