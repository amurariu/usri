...
kirc.data.limma.asym0.80 <- lim.fun(kirc.data, kirc.conds, 100, mean = 0, prop_null = 0.80)
save(kirc.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym0.prop80.Rda") 
