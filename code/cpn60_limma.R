# running Limma on cpn60 dataset (ST3, abx vs. no abx exposure)
...
cpn60.data.limma <- lim.fun(data = cpn60.counts, conditions = cpn60.meta$abx,
                            nloop = 100, mean = 0, prop_null = 0.95)

save(cpn60.data.limma, file = "../ext_analysis/cpn60.data.limma.Rda")
