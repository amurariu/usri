...
#save file - gamma = 0.4
luad.data_4.aldex3 <- ald3.fun(data=luad.data, conds=luad.conds$conditions_lu, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(luad.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/luad.data.aldex3_4.Rda")
