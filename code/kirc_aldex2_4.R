...
#save file - gamma = 0.4
kirc.data_4.aldex2 <- ald2.fun(data=kirc.data, conditions=kirc.conds$conditions_k, nloop=100, gamma=0.4)
save(kirc.data_4.aldex2, file="/Volumes/data2/andreea/ext_analysis/kirc.data.aldex2_4.Rda")