...
luad.data.limma.asym1.80 <- lim.fun(luad.data, luad.conds, 100, mean = 1, prop_null = 0.80)
save(luad.data.limma.asym1.80, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym1.prop80.Rda") 