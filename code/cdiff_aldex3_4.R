...
cdiff.data_4.aldex3 <- ald3.fun(data=as.matrix(cdiff.filt), conds=conditions_c$comparison, nloop=100, gamma=0.4, prop_null = 0.95, mean = 0)
save(cdiff.data_4.aldex3, file="/Volumes/data2/andreea/ext_analysis/cdiff.data.aldex3_4.Rda")
