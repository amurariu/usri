...
yeast.data_0.aldex3 <- ald3.fun(data=yeast.data, conds=yeast.conds$conditions_y, nloop=100, gamma=1e-3, prop_null = 0.95, mean = 0)
save(yeast.data_0.aldex3, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex3_0.Rda")