...
kirc.data.limma.asym1.90 <- lim.fun(kirc.data, kirc.conds, 100, mean = 1, prop_null = 0.90)
save(kirc.data.limma.asym1.90, file="/Volumes/data2/andreea/ext_analysis/kirc.data.limma.asym1.prop90.Rda") 
