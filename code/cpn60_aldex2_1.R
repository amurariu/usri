# running aldex2 (0.1 gamma) on cpn60 dataset (ST3, abx vs. no abx exposure)
...
cpn60.data.aldex2.1 <- ald2.fun(data = cpn60.counts, nloop = 100,
                                conditions = cpn60.meta$abx, gamma = 0.1)

save(cpn60.data.aldex2.1, file = "../ext_analysis/cpn60.data.aldex2_1.Rda")
