...
immuno.data_2.aldex3 <- ald3.fun(data=immuno.data, conds=immuno.conds$conditions_p, nloop=100, gamma=0.2)
save(immuno.data_2.aldex3, file="/Volumes/data2/andreea/ext_analysis/immuno.data.aldex3_2.Rda")
