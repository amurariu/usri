...
luad.data.limma.asym1.70 <- lim.fun(luad.data, luad.conds, 100, mean = 1, prop_null = 0.70)
save(luad.data.limma.asym1.70, file="/Volumes/data2/andreea/ext_analysis/luad.data.limma.asym1.prop70.Rda") 