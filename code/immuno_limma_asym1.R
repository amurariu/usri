...
immuno.data.limma.asym1 <- lim.fun(immuno.data, immuno.conds, 100, mean = 1)
save(immuno.data.limma.asym1, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym1.Rda") 
