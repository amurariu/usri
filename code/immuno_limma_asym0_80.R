...
immuno.data.limma.asym0.80 <- lim.fun(immuno.data, immuno.conds, 100, mean = 0, prop_null = 0.80)
save(immuno.data.limma.asym0.80, file="/Volumes/data2/andreea/ext_analysis/immuno.data.limma.asym0.prop80.Rda") 
