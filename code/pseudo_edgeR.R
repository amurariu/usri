...
# run edgeR, then save
pseudo.data.edgeR <- edg.fun(data = sc.pseudo, conditions = conds.stim$stim, nloop = 100, prop_null = 0.95, mean = 0, std = 2)
save(pseudo.data.edgeR, file="~/Documents/GitHub/ext_analysis/pseudo_sc.data.edger.Rda")
