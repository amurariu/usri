...
#save file - gamma=0.2
yeast.data_2.aldex2 <- ald2.fun(data=yeast.data, conditions=yeast.conds$conditions_y, nloop=100, gamma=0.2)
save(yeast.data_2.aldex2, file="/Volumes/data2/andreea/ext_analysis/yeast.data.aldex2_2.Rda")