# running aldex3 (0.1 gamma) on cpn60 dataset (ST3, abx vs. no abx exposure)
...
cpn60.data.aldex3.1 <- ald3.fun(data = cpn60.counts, nloop = 100,
                                conds = cpn60.meta$abx, gamma = 0.1)

save(cpn60.data.aldex3.1, file = "../ext_analysis/mts.data.aldex3_1.Rda")
