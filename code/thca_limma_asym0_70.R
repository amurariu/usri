...
thca.data.limma.asym0.70 <- lim.fun(thca.data, thca.conds, 100, mean = 0, prop_null = 0.70)
save(thca.data.limma.asym0.70, file="/Volumes/data2/andreea/ext_analysis/thca.data.limma.asym0.prop70.Rda") 