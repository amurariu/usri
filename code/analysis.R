...
immuno.analysis <- analysis.fun(analysis.deseq = immuno.data.DESeq, analysis.edgeR = immuno.data.edgeR, analysis.aldex0 = immuno.data_0.aldex2, analysis.aldex0.2 = immuno.data_2.aldex2, analysis.aldex0.5 = immuno.data_5.aldex2) 
